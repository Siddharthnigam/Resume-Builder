...
const ResumeForm = () => {
    ...
    return (
        <>
            <div className="nahru1">
                <section>
                    <form onSubmit={handleSubmit} className="resume-form">
                        <div className="color">
                            <button onClick={() => changeBackgroundColor('#f25c54')}>
                                Red
                            </button>
                            <button onClick={() => changeBackgroundColor('#adc178')}>
                                Green
                            </button>
                            <button onClick={() => changeBackgroundColor('#90e0ef')}>
                                Blue
                            </button>
                            <button onClick={() => changeBackgroundColor('#ffd000')}>
                                Yellow
                            </button>
                            <button onClick={() => changeBackgroundColor('#b08968')}>
                                Brown
                            </button>
                            <button onClick={() => changeBackgroundColor('#adb5bd')}>
                                Grey
                            </button>
                        </div>
                        <div>
...
const ResumeTemplate = ({ formData }) => {
    return (
        <>
            <div className="container3" id="resume-template">
                <div className="header1 hi">
                    <div>
